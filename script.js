...
const files = {
    ...
    content: [{
        ...
        content: [{
            ...
            name: "Splatoon",
            type: "text",
            content: "aHR0cHM6Ly9kaXNjb3JkLmNvbS9jaGFubmVscy8xMjc5NjMxMTA0MzI3OTQ2MzAxLzEyODAzNTE3NzQxNTgzNTY0OTA"
        }]
    },{
        name: "characterFiles",
        type: "folder",
        ...
        content: [{name: "2026march", type: "folder", content: [{
            ...
            type: "html",
            content: `
                <p>Hello again! So remember when I said that I was making this for myself personally? Well, I kinda lied about that. I am planning to show this to a group of people at some point, a community of sorts. I have no idea if you are that group, or if you're someone else, but either way you reading this may or may not be intended. Anyways, I've also been planning to put a few things here and there, like maybe an RSS feed I could update whenever there's new details on the Warren's and Pinkbox situation? I dunno, either way I'll keep working on this. Still need to figure out what else to add, though... oh well, I'll just go ahead and see how people are reacting to Pokopia in the meantime. See if it's living up to the hype.
                <br><br>
                - █████</p>
            `
        },{
            ...
            type: "html",
            content: `
                <p>I have been wondering on how I could have a way to notify people on an update to the website. I know I could just have a feed for devlogs or something, but I want it so that only the people who are intended to see this site will know when it gets updated, and have it convenient for them while still keeping it somewhat hidden for those who aren't intended to see any of this. Situations like these puzzle me, but I also enjoy them in a way. Taking challenging situations and attempting to solve them is very much something I love to do. Anyways, I'll probably make another note once I have an idea.
                <br><br>
                - █████<br>
                P.S. Happy Mario day!</p>
            `
        },{
            name: "2026March11th",
            type: "html",
            content: `<p>I've gotten an idea.<br>
...
function openRelativeFile(fileLocation){
    file = openFile(currentFolder.concat(fileLocation))
    if(file.type == "folder"){
        if(currentFolder[0] != 4 && currentFolder[1] != 0){currentFolder.push(fileLocation)}
        openFolder()
    }
}
